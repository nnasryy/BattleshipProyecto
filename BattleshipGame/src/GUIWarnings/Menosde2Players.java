 ...
 * @author nasry
 */
public class Menosde2Players {
    
    private JFrame frame;

    public Menosde2Players() {
        ...
        JLabel mensaje = new JLabel("Al menos 2 usuarios deben de estar registrados");
        mensaje.setBounds(50, 120, 600, 40);
        mensaje.setFont(new Font("Cold Warm", Font.PLAIN, 22));
