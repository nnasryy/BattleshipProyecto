 ...
 * @author nasry
 */
public class MaximoDeNaves {

    private JFrame frame;

    public MaximoDeNaves() {
        ...
        JLabel mensaje = new JLabel("Ya has alcanzado el maximo de naves de este tipo");
        mensaje.setBounds(60, 120, 600, 40);
